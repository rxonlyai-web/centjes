export default function IBLoading() {
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '4rem 2rem' }}>
      ...
      {/* Chart placeholder */}
      <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, height: 400, marginBottom: '3rem' }} />
    </div>
  )
}
