...
import { login, signInWithGoogle, getGoogleOAuthUrl } from '../auth/actions'
      ...
      <div className={styles.wrapper}>
        ...
        {!showEmailForm ? (
          ...
          <div className={styles.form}>
            {native ? (
              // Native Capacitor app: use getGoogleOAuthUrl + Browser.open
              <button
              ...
              >
                ...
                {oauthLoading ? 'Even geduld...' : 'Doorgaan met Google'}
              </button>
            ) : (
              // Web: use signInWithGoogle server action (same as register page)
              <form>
                <button
